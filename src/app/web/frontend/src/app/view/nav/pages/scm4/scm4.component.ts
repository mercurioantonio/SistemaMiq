...
@Component({
  selector: 'app-scm4',
  templateUrl: './scm4.component.html',
  styleUrls: ['./scm4.component.less']
})
export class Scm4Component {
  ...
  ngOnInit(): void {
    this.scambio.selectedMiq$.subscribe((test: any) => {
      ...
      console.log("scm4.component.ts chiama getAnagrafica di: ", this.selectedMiq)
      ...
      console.log("scm4.component.ts riceve l'anagrafica di: ",this.selectedMiq, "con status: ",this.status, this.dataframeData)
...
//      cid: [[], [Validators.required,Validators.pattern("^[0-9]*$"),Validators.minLength(8), Validators.maxLength(8)]],
  ...
  campione(campione_di_riferimento:string): void{
    ...
    console.log("scm4.component.ts ha individuato questo campione_di riferimento: ", campione_di_riferimento);
