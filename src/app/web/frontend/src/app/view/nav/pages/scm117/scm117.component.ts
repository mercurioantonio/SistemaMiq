...
@Component({
  selector: 'app-scm117',
  templateUrl: './scm117.component.html',
  styleUrls: ['./scm117.component.less']
})
export class Scm117Component {
  ...
  ngOnInit(): void {
    this.scambio.selectedMiq$.subscribe((test: any) => {
      ...
      console.log("scm117.component.ts chiama getAnagrafica di: ", this.selectedMiq)
      ...
      console.log("scm117.component.ts riceve l'anagrafica di: ",this.selectedMiq, "con status: ",this.status, this.dataframeData)
...
calcolaDifferenze_D(){
  ...
  private getWeekNumber(date: Date): number {
   ...
   campione(campione_di_riferimento:string): void{
    ...
    console.log("scm117.component.ts ha individuato questo campione_di riferimento: ", campione_di_riferimento);
