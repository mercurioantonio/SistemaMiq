...
@Component({
  selector: 'app-scm3',
  templateUrl: './scm3.component.html',
  styleUrls: ['./scm3.component.less']
})
export class Scm3Component {
  ...
  ngOnInit(): void {
    this.scambio.selectedMiq$.subscribe((test: any) => {
      ...
      console.log("scm3.component.ts chiama getAnagrafica di: ", this.selectedMiq)
      ...
      console.log("scm3.component.ts riceve l'anagrafica di: ",this.selectedMiq, "con status: ",this.status, this.dataframeData)
...
changeFrequency_succ(){
  ...
  private getWeekNumber(date: Date): number {
   ...
   campione(campione_di_riferimento:string): void{
    ...
    console.log("scm3.component.ts ha individuato questo campione_di riferimento: ", campione_di_riferimento);
