...
@Component({
  selector: 'app-scm104',
  templateUrl: './scm104.component.html',
  styleUrls: ['./scm104.component.less']
})
export class Scm104Component {
  ...
  ngOnInit(): void {
    this.scambio.selectedMiq$.subscribe((test: any) => {
      ...
      console.log("scm104.component.ts chiama getAnagrafica di: ", this.selectedMiq)
      ...
      console.log("scm104.component.ts riceve l'anagrafica di: ",this.selectedMiq, "con status: ",this.status, this.dataframeData)
...
calcolaDifferenze_C() {
  ...
  private getWeekNumber(date: Date): number {
   ...
   campione(campione_di_riferimento:string): void{
    ...
    console.log("scm104.component.ts ha individuato questo campione_di riferimento: ", campione_di_riferimento);
