...
@Component({
  selector: 'app-scm8',
  templateUrl: './scm8.component.html',
  styleUrls: ['./scm8.component.less']
})
export class Scm8Component {
  ...
  ngOnInit(): void {
    this.scambio.selectedMiq$.subscribe((test: any) => {
      ...
      console.log("scm8.component.ts chiama getAnagrafica di: ", this.selectedMiq)
      ...
      console.log("scm8.component.ts riceve l'anagrafica di: ",this.selectedMiq, "con status: ",this.status, this.dataframeData)
...
calcolaDifferenze_E(){
  ...
  private getWeekNumber(date: Date): number {
   ...
   campione(campione_di_riferimento:string): void{
    ...
    console.log("scm8.component.ts ha individuato questo campione_di riferimento: ", campione_di_riferimento);
