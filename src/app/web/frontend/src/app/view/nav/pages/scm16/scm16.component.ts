...
@Component({
  selector: 'app-scm16',
  templateUrl: './scm16.component.html',
  styleUrls: ['./scm16.component.less']
})
export class Scm16Component {
  ...
  ngOnInit(): void {
    this.scambio.selectedMiq$.subscribe((test: any) => {
      ...
      console.log("scm16.component.ts chiama getAnagrafica di: ", this.selectedMiq)
      ...
      console.log("scm16.component.ts riceve l'anagrafica di: ",this.selectedMiq, "con status: ",this.status, this.dataframeData)
...
//      cid: [[], [Validators.required,Validators.pattern("^[0-9]*$"),Validators.minLength(8), Validators.maxLength(8)]],
  ...
  private getWeekNumber(date: Date): number {
   ...
   campione(campione_di_riferimento:string): void{
    ...
    console.log("scm16.component.ts ha individuato questo campione_di riferimento: ", campione_di_riferimento);
