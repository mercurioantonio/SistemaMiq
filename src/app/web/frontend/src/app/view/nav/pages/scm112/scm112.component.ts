...
@Component({
  selector: 'app-scm112',
  templateUrl: './scm112.component.html',
  styleUrls: ['./scm112.component.less']
})
export class Scm112Component {
  ...
  calibrazione_E: any;
  val_calib_E: any;
  val_calib_master_E: any;
  calibrazione_F: any;
  val_calib_F: any;
  val_calib_master_F: any;
  pt_int_A: any;
  pt_int_B: any;
  pt_int_C: any;
  pt_int_D: any;
  ...
  mediaDifferenze_E: number = NaN;
  mediaDifferenze_F: number = NaN;
  range_A: number = NaN;
  range_B: number = NaN;
  range_C: number = NaN;
  range_D: number = NaN;
  ...
  ngOnInit(): void {
    this.scambio.selectedMiq$.subscribe((test: any) => {
      ...
      console.log("scm112.component.ts chiama getAnagrafica di: ", this.selectedMiq)
      ...
      console.log("scm112.component.ts riceve l'anagrafica di: ",this.selectedMiq, "con status: ",this.status, this.dataframeData)
      ...
      this.y1_master_E = this.pt_int_E
      this.y2_master_E = this.pt_int_E
      this.y3_master_E = this.pt_int_E
      this.y4_master_E = this.pt_int_E
      this.y5_master_E = this.pt_int_E
      this.y1_master_F = this.pt_int_F
      this.y2_master_F = this.pt_int_F
      this.y3_master_F = this.pt_int_F
      this.y4_master_F = this.pt_int_F
      this.y5_master_F = this.pt_int_F
      ...
      this.val_calib_master_E = this.pt_int_E
      this.val_calib_master_F = this.pt_int_F
...
//      cid: [[], [Validators.required,Validators.pattern("^[0-9]*$"),Validators.minLength(8), Validators.maxLength(8)]],
  ...
  submitForm(): void {
    ...
    var check_pt_int_E = 0
    var check_pt_int_F = 0
    ...
    if (this.validateForm.valid) {
      if(this.pt_int_E != ''){
        console.log("sono entato nel check E")
        this.validateForm.get('y1_strum_E')?.setValidators([Validators.required]);
        this.validateForm.get('y2_strum_E')?.setValidators([Validators.required]);
        this.validateForm.get('y3_strum_E')?.setValidators([Validators.required]);
        this.validateForm.get('y4_strum_E')?.setValidators([Validators.required]);
        this.validateForm.get('y5_strum_E')?.setValidators([Validators.required]);
        this.validateForm.get('y1_master_E')?.setValidators([Validators.required]);
        this.validateForm.get('y2_master_E')?.setValidators([Validators.required]);
        this.validateForm.get('y3_master_E')?.setValidators([Validators.required]);
        this.validateForm.get('y4_master_E')?.setValidators([Validators.required]);
        this.validateForm.get('y5_master_E')?.setValidators([Validators.required]);
        this.validateForm.get('calibrazione_E')?.setValidators([Validators.required]);
        check_pt_int_E = 1;
      }
    }
    ...
    if (this.validateForm.valid) {
      if(this.pt_int_F != ''){
        console.log("sono entato nel check F")
        this.validateForm.get('y1_strum_F')?.setValidators([Validators.required]);
        this.validateForm.get('y2_strum_F')?.setValidators([Validators.required]);
        this.validateForm.get('y3_strum_F')?.setValidators([Validators.required]);
        this.validateForm.get('y4_strum_F')?.setValidators([Validators.required]);
        this.validateForm.get('y5_strum_F')?.setValidators([Validators.required]);
        this.validateForm.get('y1_master_F')?.setValidators([Validators.required]);
        this.validateForm.get('y2_master_F')?.setValidators([Validators.required]);
        this.validateForm.get('y3_master_F')?.setValidators([Validators.required]);
        this.validateForm.get('y4_master_F')?.setValidators([Validators.required]);
        this.validateForm.get('y5_master_F')?.setValidators([Validators.required]);
        this.validateForm.get('calibrazione_F')?.setValidators([Validators.required]);
        check_pt_int_F = 1;
      }
    }
    ...
    if (this.validateForm.valid) {
       ...
       if (this.cal_option5 == 'true') {
        console.log("option5 true and option5=1")
        this.validateForm.get('val_calib_E')?.setValidators([Validators.required]);
        this.validateForm.get('val_calib_master_E')?.setValidators([Validators.required]);
        option5 = 1
       }
       if (this.cal_option6 == 'true') {
        console.log("option6 true and option6=1")
        this.validateForm.get('val_calib_F')?.setValidators([Validators.required]);
        this.validateForm.get('val_calib_master_F')?.setValidators([Validators.required]);
        option6 = 1
       }
       console.log(option1, option2, option3, option4, option5, option6)
        ...
        if (option5 == 1 && this.validateForm.value.val_calib_E && this.validateForm.value.val_calib_master_E){
          console.log("option5=1 e ora val5=1")
          val5 = 1
        }
        if (option6 == 1 && this.validateForm.value.val_calib_F && this.validateForm.value.val_calib_master_F){
          console.log("option6=1 e ora val6=1")
          val6 = 1
        }
        ...
        if (check_pt_int_B === 0){
          ...
          this.validateForm.value.y1_strum_E = null;
          this.validateForm.value.y2_strum_E = null;
          this.validateForm.value.y3_strum_E = null;
          this.validateForm.value.y4_strum_E = null;
          this.validateForm.value.y5_strum_E = null;
          this.validateForm.value.y1_master_E = null;
          this.validateForm.value.y2_master_E = null;
          this.validateForm.value.y3_master_E = null;
          this.validateForm.value.y4_master_E = null;
          this.validateForm.value.y5_master_E = null;
          this.validateForm.value.calibrazione_E = null;
          this.validateForm.value.y1_strum_F = null;
          this.validateForm.value.y2_strum_F = null;
          this.validateForm.value.y3_strum_F = null;
          this.validateForm.value.y4_strum_F = null;
          this.validateForm.value.y5_strum_F = null;
          this.validateForm.value.y1_master_F = null;
          this.validateForm.value.y2_master_F = null;
          this.validateForm.value.y3_master_F = null;
          this.validateForm.value.y4_master_F = null;
          this.validateForm.value.y5_master_F = null;
          this.validateForm.value.calibrazione_F = null;
          if(option1+option2+option3+option4+option5+option6 === 0){
            ...
            this.validateForm.value.val_calib_E = null;
            this.validateForm.value.val_calib_F = null;
            ...
            this.validateForm.value.val_calib_master_E = null;
            this.validateForm.value.val_calib_master_F = null;
          ...
          else if(option1+option2+option3+option4+option5+option6 === val1+val2+val3+val4+val5+val6){
            if(option1 === 0){
              this.validateForm.value.val_calib_A = null;
              this.validateForm.value.val_calib_master_A = null;
            }
    ...
    else if (check_pt_int_E === 0){
      console.log("check_pt_int_E = 0")
      this.validateForm.value.y1_strum_E = null;
      this.validateForm.value.y2_strum_E = null;
      this.validateForm.value.y3_strum_E = null;
      this.validateForm.value.y4_strum_E = null;
    ...
    else if (check_pt_int_F === 0){
      console.log("check_pt_int_F = 0")
      this.validateForm.value.y1_strum_F = null;
      this.validateForm.value.y2_strum_F = null;
      this.validateForm.value.y3_strum_F = null;
      this.validateForm.value.y4_strum_F = null;
      ...
      else if(option1+option2+option3+option4+option5+option6 === val1+val2+val3+val4+val5+option6){
        if(option1 === 0){
          this.validateForm.value.val_calib_A = null;
          this.validateForm.value.val_calib_master_A = null;
        }
...
calcolaDifferenze_A() {
  ...
  console.log("y1_str: ", y1_strum_A)
  console.log("y1_mas: ", y1_master_A)
  console.log("this.pt_int_A: ", this.pt_int_A)
  ...
  console.log("differenze_A: ", differenze_A)
...
calcolaDifferenze_D(){
  ...
  const sommaDifferenze_D = differenze_D.reduce((acc, diff) => acc + diff, 0);
...
calcolaDifferenze_E(){
  ...
  const y1_strum_E = parseFloat((document.getElementById("y1_strum_E") as HTMLInputElement).value.replace(',','.'));
  const y2_strum_E = parseFloat((document.getElementById("y2_strum_E") as HTMLInputElement).value.replace(',','.'));
  const y3_strum_E = parseFloat((document.getElementById("y3_strum_E") as HTMLInputElement).value.replace(',','.'));
  const y4_strum_E = parseFloat((document.getElementById("y4_strum_E") as HTMLInputElement).value.replace(',','.'));
  const y5_strum_E = parseFloat((document.getElementById("y5_strum_E") as HTMLInputElement).value.replace(',','.'));

  const y1_master_E = parseFloat((document.getElementById("y1_master_E") as HTMLInputElement).value.replace(',','.'));
  const y2_master_E = parseFloat((document.getElementById("y2_master_E") as HTMLInputElement).value.replace(',','.'));
  const y3_master_E = parseFloat((document.getElementById("y3_master_E") as HTMLInputElement).value.replace(',','.'));
  const y4_master_E = parseFloat((document.getElementById("y4_master_E") as HTMLInputElement).value.replace(',','.'));
  const y5_master_E = parseFloat((document.getElementById("y5_master_E") as HTMLInputElement).value.replace(',','.'));

  var differenze_E = [(y1_strum_E - y1_master_E), (y2_strum_E - y2_master_E), (y3_strum_E - y3_master_E), (y4_strum_E - y4_master_E), (y5_strum_E - y5_master_E)];
  differenze_E = differenze_E.map((valore) => isNaN(valore) || !isFinite(valore) ? 0 : valore);
  const sommaDifferenze_E = differenze_E.reduce((acc, diff) => acc + diff, 0);
  this.mediaDifferenze_E = differenze_E.length > 0 ? sommaDifferenze_E / differenze_E.length : 0;

  const maxDifferenza_E = Math.max(...differenze_E);
  const minDifferenza_E = Math.min(...differenze_E);
  this.range_E = maxDifferenza_E - minDifferenza_E;

  if(LIC_x <= this.mediaDifferenze_E && this.mediaDifferenze_E <= LSC_x ){
    this.esito_E_x = 'True';
  }
  else{
    this.esito_E_x = 'False';
  }
  if(LIC_r <= this.range_E && this.range_E <= LSC_r ){
    this.esito_E_r = 'True';
  }
  else{
    this.esito_E_r = 'False';
  }
  if((y1_strum_E + y2_strum_E + y3_strum_E + y4_strum_E + y5_strum_E) / differenze_E.length <= Number(this.pt_int_E.replace(',','.')) - (Number(this.T_pre.replace(',','.'))/2)  || (y1_strum_E + y2_strum_E + y3_strum_E + y4_strum_E + y5_strum_E) / differenze_E.length >= Number(this.pt_int_E.replace(',','.'))+ (Number(this.T_pre.replace(',','.'))/2)){
    this.esito_E_bias = 'True';
  }
  else{
    this.esito_E_bias = 'False';
  }
}
...
calcolaDifferenze_F(){
  ...
  const y1_strum_F = parseFloat((document.getElementById("y1_strum_F") as HTMLInputElement).value.replace(',','.'));
  const y2_strum_F = parseFloat((document.getElementById("y2_strum_F") as HTMLInputElement).value.replace(',','.'));
  const y3_strum_F = parseFloat((document.getElementById("y3_strum_F") as HTMLInputElement).value.replace(',','.'));
  const y4_strum_F = parseFloat((document.getElementById("y4_strum_F") as HTMLInputElement).value.replace(',','.'));
  const y5_strum_F = parseFloat((document.getElementById("y5_strum_F") as HTMLInputElement).value.replace(',','.'));

  const y1_master_F = parseFloat((document.getElementById("y1_master_F") as HTMLInputElement).value.replace(',','.'));
  const y2_master_F = parseFloat((document.getElementById("y2_master_F") as HTMLInputElement).value.replace(',','.'));
  const y3_master_F = parseFloat((document.getElementById("y3_master_F") as HTMLInputElement).value.replace(',','.'));
  const y4_master_F = parseFloat((document.getElementById("y4_master_F") as HTMLInputElement).value.replace(',','.'));
  const y5_master_F = parseFloat((document.getElementById("y5_master_F") as HTMLInputElement).value.replace(',','.'));

  var differenze_F = [(y1_strum_F - y1_master_F), (y2_strum_F - y2_master_F), (y3_strum_F - y3_master_F), (y4_strum_F - y4_master_F), (y5_strum_F - y5_master_F)];
  differenze_F = differenze_F.map((valore) => isNaN(valore) || !isFinite(valore) ? 0 : valore);
  const sommaDifferenze_F = differenze_F.reduce((acc, diff) => acc + diff, 0);
  this.mediaDifferenze_F = differenze_F.length > 0 ? sommaDifferenze_F / differenze_F.length : 0;

  const maxDifferenza_F = Math.max(...differenze_F);
  const minDifferenza_F = Math.min(...differenze_F);
  this.range_F = maxDifferenza_F - minDifferenza_F;

  if(LIC_x <= this.mediaDifferenze_F && this.mediaDifferenze_F <= LSC_x ){
    this.esito_F_x = 'True';
  }
  else{
    this.esito_F_x = 'False';
  }
  if(LIC_r <= this.range_F && this.range_F <= LSC_r ){
    this.esito_F_r = 'True';
  }
  else{
    this.esito_F_r = 'False';
  }
  if((y1_strum_F + y2_strum_F + y3_strum_F + y4_strum_F + y5_strum_F) / differenze_F.length <= Number(this.pt_int_F.replace(',','.')) - (Number(this.T_pre.replace(',','.'))/2)  || (y1_strum_F + y2_strum_F + y3_strum_F + y4_strum_F + y5_strum_F) / differenze_F.length >= Number(this.pt_int_F.replace(',','.'))+ (Number(this.T_pre.replace(',','.'))/2)){
    this.esito_F_bias = 'True';
  }
  else{
    this.esito_F_bias = 'False';
  }
}
  ...
  showModal(): void {
    ...
    if(this.y1_strum_E == ''){
      this.y1_strum_E = null
    }
    if(this.y2_strum_E == ''){
      this.y2_strum_E = null
    }
    if(this.y3_strum_E == ''){
      this.y3_strum_E = null
    }
    if(this.y4_strum_E == ''){
      this.y4_strum_E = null
    }
    if(this.y5_strum_E == ''){
      this.y5_strum_E = null
    }
    if(this.y1_strum_F == ''){
      this.y1_strum_F = null
    }
    if(this.y2_strum_F == ''){
      this.y2_strum_F = null
    }
    if(this.y3_strum_F == ''){
      this.y3_strum_F  = null
    }
    if(this.y4_strum_F == ''){
      this.y4_strum_F = null
    }
    if(this.y5_strum_F == ''){
      this.y5_strum_F = null
    }
    ...
    if(this.y1_master_E == ''){
      this.y1_master_E = null
    }
    if(this.y2_master_E == ''){
      this.y2_master_E = null
    }
    if(this.y3_master_E == ''){
      this.y3_master_E = null
    }
    if(this.y4_master_E == ''){
      this.y4_master_E = null
    }
    if(this.y5_master_E == ''){
      this.y5_master_E = null
    }
    if(this.y1_master_F == ''){
      this.y1_master_F = null
    }
    if(this.y2_master_F == ''){
      this.y2_master_F = null
    }
    if(this.y3_master_F == ''){
      this.y3_master_F = null
    }
    if(this.y4_master_F == ''){
      this.y4_master_F = null
    }
    if(this.y5_master_F == ''){
      this.y5_master_F = null
    }
    ...
    if(this.pt_int_E == ''){
      ...
      this.y4_master_E = null;
      this.y5_master_E = null;
      this.calibrazione_E = null;
      this.val_calib_E = null;
      this.val_calib_master_E = null;
      Enull = 1;
    }
    if(this.pt_int_F == ''){
      this.esito_F_x = 'True'; 
      ...
      this.y4_master_F = null;
      this.y5_master_F = null;
      this.calibrazione_F = null;
      this.val_calib_F = null;
      this.val_calib_master_F = null;
      Enull = 1;
    }
    ...
    if (Bnull ==1){
      if(this.y1_strum_A == undefined|| this.y2_strum_A == undefined || this.y3_strum_A == undefined || this.y4_strum_A == undefined || this.y5_strum_A == undefined || 
        ...
        if (this.esito_A_x == 'True' && this.esito_A_r == 'True' && this.esito_B_x == 'True' && this.esito_B_r == 'True' && this.esito_C_x == 'True' && this.esito_C_r == 'True' && this.esito_D_x == 'True' && this.esito_D_r == 'True' && this.esito_E_x == 'True' && this.esito_E_r == 'True' && this.esito_F_x == 'True' && this.esito_F_r == 'True' && this.validateForm.valid){
          this.submitForm();
          this.showModal_ok();
      ...
      if(this.y1_strum_A == undefined|| this.y2_strum_A == undefined || this.y3_strum_A == undefined || this.y4_strum_A == undefined || this.y5_strum_A == undefined ||
        ...
        this.y1_strum_C == undefined|| this.y2_strum_C == undefined || this.y3_strum_C == undefined || this.y4_strum_C == undefined || this.y5_strum_C == undefined ||
        this.y1_strum_D == undefined || this.y2_strum_D == undefined || this.y3_strum_D == undefined || this.y4_strum_D == undefined || this.y5_strum_D == undefined || 
        this.y1_strum_E == undefined || this.y2_strum_E == undefined || this.y3_strum_E == undefined || this.y4_strum_E == undefined || this.y5_strum_E == undefined || 
        this.y1_master_A == undefined || this.y2_master_A == undefined || this.y3_master_A == undefined || this.y4_master_A == undefined || this.y5_master_A == undefined ||
        this.y1_master_B == undefined || this.y2_master_B == undefined || this.y3_master_B == undefined || this.y4_master_B == undefined || this.y5_master_B == undefined ||
        this.y1_master_C == undefined || this.y2_master_C == undefined || this.y3_master_C == undefined || this.y4_master_C == undefined || this.y5_master_C == undefined ||
        this.y1_master_D == undefined || this.y2_master_D == undefined || this.y3_master_D == undefined || this.y4_master_D == undefined || this.y5_master_D == undefined || 
        this.y1_master_E == undefined || this.y2_master_E == undefined || this.y3_master_E == undefined || this.y4_master_E == undefined || this.y5_master_E == undefined ||
        this.cal_option1 == undefined || this.cal_option2 == undefined || this.cal_option3 == undefined || this.cal_option4 == undefined || this.cal_option5 == undefined 
        ){
          this.showModal_ko();
        }
      else{
      ...
      if(this.y1_strum_A == undefined|| this.y2_strum_A == undefined || this.y3_strum_A == undefined || this.y4_strum_A == undefined || this.y5_strum_A == undefined ||
        ...
        this.y1_strum_D == undefined || this.y2_strum_D == undefined || this.y3_strum_D == undefined || this.y4_strum_D == undefined || this.y5_strum_D == undefined || 
        this.y1_strum_E == undefined || this.y2_strum_E == undefined || this.y3_strum_E == undefined || this.y4_strum_E == undefined || this.y5_strum_E == undefined || 
        this.y1_strum_F == undefined || this.y2_strum_F == undefined || this.y3_strum_F == undefined || this.y4_strum_F == undefined || this.y5_strum_F == undefined || 
        this.y1_master_A == undefined || this.y2_master_A == undefined || this.y3_master_A == undefined || this.y4_master_A == undefined || this.y5_master_A == undefined ||
        this.y1_master_B == undefined || this.y2_master_B == undefined || this.y3_master_B == undefined || this.y4_master_B == undefined || this.y5_master_B == undefined ||
        this.y1_master_C == undefined || this.y2_master_C == undefined || this.y3_master_C == undefined || this.y4_master_C == undefined || this.y5_master_C == undefined ||
        this.y1_master_D == undefined || this.y2_master_D == undefined || this.y3_master_D == undefined || this.y4_master_D == undefined || this.y5_master_D == undefined ||
        this.y1_master_E == undefined || this.y2_master_E == undefined || this.y3_master_E == undefined || this.y4_master_E == undefined || this.y5_master_E == undefined || 
        this.y1_master_F == undefined || this.y2_master_F == undefined || this.y3_master_F == undefined || this.y4_master_F == undefined || this.y5_master_F == undefined ||
        this.cal_option1  == undefined || this.cal_option2 == undefined || this.cal_option3 == undefined || this.cal_option4 == undefined || this.cal_option5 == undefined || this.cal_option6 == undefined  
        ){
          this.showModal_ko();
        }
      else{
  ...
  private getWeekNumber(date: Date): number {
   ...
   campione(campione_di_riferimento:string): void{
    ...
    console.log("scm112.component.ts ha individuato questo campione_di riferimento: ", campione_di_riferimento);
    this.service.searchCampione(campione_di_riferimento).subscribe((res) => { 
      ...
      console.log("dataframeCampione: ", this.dataframeCampione)
      console.log("status di campione(): ", this.status_campione)
    }); 
  }
