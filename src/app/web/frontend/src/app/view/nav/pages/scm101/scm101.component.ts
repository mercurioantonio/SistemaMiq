...
@Component({
  selector: 'app-scm101',
  templateUrl: './scm101.component.html',
  styleUrls: ['./scm101.component.less']
})
export class Scm101Component {
  ...
  ngOnInit(): void {
    this.scambio.selectedMiq$.subscribe((test: any) => {
      ...
      console.log("scm101.component.ts chiama getAnagrafica di: ", this.selectedMiq)
      ...
      console.log("scm101.component.ts riceve l'anagrafica di: ",this.selectedMiq, "con status: ",this.status, this.dataframeData)
...
calcolaDifferenze_D(){
  ...
  private getWeekNumber(date: Date): number {
   ...
   campione(campione_di_riferimento:string): void{
    ...
    console.log("scm101.component.ts ha individuato questo campione_di riferimento: ", campione_di_riferimento);
