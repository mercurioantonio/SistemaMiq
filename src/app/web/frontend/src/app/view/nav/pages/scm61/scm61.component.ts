...
@Component({
  selector: 'app-scm61',
  templateUrl: './scm61.component.html',
  styleUrls: ['./scm61.component.less']
})
export class Scm61Component {
    ...
    ngOnInit(): void {
      this.scambio.selectedMiq$.subscribe((test: any) => {
        ...
        console.log("scm61.component.ts chiama getAnagrafica di: ", this.selectedMiq)
        ...
        console.log("scm61.component.ts riceve l'anagrafica di: ",this.selectedMiq, "con status: ",this.status, this.dataframeData)
   ...
   autoTips: Record<string, Record<string, string>> = {
    ...
    private getWeekNumber(date: Date): number {
     ...
     campione(campione_di_riferimento:string): void{
      ...
      console.log("scm61.component.ts ha individuato questo campione_di riferimento: ", campione_di_riferimento);
