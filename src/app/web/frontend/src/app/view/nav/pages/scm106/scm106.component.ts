...
@Component({
  selector: 'app-scm106',
  templateUrl: './scm106.component.html',
  styleUrls: ['./scm106.component.less']
})
export class Scm106Component {
  ...
  ngOnInit(): void {
    this.scambio.selectedMiq$.subscribe((test: any) => {
      ...
      console.log("scm106.component.ts chiama getAnagrafica di: ", this.selectedMiq)
      ...
      console.log("scm106.component.ts riceve l'anagrafica di: ",this.selectedMiq, "con status: ",this.status, this.dataframeData)
...
//      cid: [[], [Validators.required,Validators.pattern("^[0-9]*$"),Validators.minLength(8), Validators.maxLength(8)]],
      ...
      val_calib_C: [[], []],  
      calibrazione_D: [[], [Validators.required]],
      val_calib_D: [[], []],   
      val_calib_master_A: [[], []], 
      val_calib_master_B: [[], []], 
      val_calib_master_C: [[], []], 
      ...
      y1_strum_D: [[], [Validators.required]],
      y2_strum_D: [[], [Validators.required]],
      y3_strum_D: [[], [Validators.required]],
      y4_strum_D: [[], [Validators.required]],
      y5_strum_D: [[], [Validators.required]],
      y1_master_D: [[], [Validators.required]],
      y2_master_D: [[], [Validators.required]],
      y3_master_D: [[], [Validators.required]],
      y4_master_D: [[], [Validators.required]],
      y5_master_D: [[], [Validators.required]],
  ...
  private getWeekNumber(date: Date): number {
   ...
   campione(campione_di_riferimento:string): void{
    ...
    console.log("scm106.component.ts ha individuato questo campione_di riferimento: ", campione_di_riferimento);
