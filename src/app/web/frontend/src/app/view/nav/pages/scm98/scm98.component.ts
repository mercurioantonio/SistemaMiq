...
@Component({
  selector: 'app-scm98',
  templateUrl: './scm98.component.html',
  styleUrls: ['./scm98.component.less']
})
export class Scm98Component {
   validateForm!: UntypedFormGroup;
    ...
    ngOnInit(): void {
      this.scambio.selectedMiq$.subscribe((test: any) => {
        ...
        console.log("scm98.component.ts chiama getAnagrafica di: ", this.selectedMiq)
        ...
        console.log("scm98.component.ts riceve l'anagrafica di: ",this.selectedMiq, "con status: ",this.status, this.dataframeData)
...
//      cid: [[], [Validators.required,Validators.pattern("^[0-9]*$"),Validators.minLength(8), Validators.maxLength(8)]],
        ...
        calibrazione: [[], [Validators.required]],
        y_A: [[], [Validators.required]],
        y_B: [[], [Validators.required]],
    ...
    showModal(): void {
      console.log('y_A', this.y_A)
      console.log('y_B', this.y_B)
      console.log('validateForm', this.validateForm)
      if (this.y_A === 'true' && this.y_B === 'false' && this.validateForm.valid){
        this.submitForm();
        this.showModal_ok();  
      }
      else {
    ...
    private getWeekNumber(date: Date): number {
     ...
     campione(campione_di_riferimento:string): void{
      ...
      console.log("scm98.component.ts ha individuato questo campione_di riferimento: ", campione_di_riferimento);
