...
@Component({
  selector: 'app-scm121',
  templateUrl: './scm121.component.html',
  styleUrls: ['./scm121.component.less']
})
export class Scm121Component {
  ...
  ngOnInit(): void {
    this.scambio.selectedMiq$.subscribe((test: any) => {
      ...
      console.log("scm121.component.ts chiama getAnagrafica di: ", this.selectedMiq)
      ...
      console.log("scm121.component.ts riceve l'anagrafica di: ",this.selectedMiq, "con status: ",this.status, this.dataframeData)
...
calcolaDifferenze_D(){
  ...
  private getWeekNumber(date: Date): number {
   ...
   campione(campione_di_riferimento:string): void{
    ...
    console.log("scm121.component.ts ha individuato questo campione_di riferimento: ", campione_di_riferimento);
