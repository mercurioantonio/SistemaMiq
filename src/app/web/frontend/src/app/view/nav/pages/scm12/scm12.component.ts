...
@Component({
  selector: 'app-scm12',
  templateUrl: './scm12.component.html',
  styleUrls: ['./scm12.component.less']
})
export class Scm12Component {
  ...
  ngOnInit(): void {
    this.scambio.selectedMiq$.subscribe((test: any) => {
      ...
      console.log("scm12.component.ts chiama getAnagrafica di: ", this.selectedMiq)
      ...
      console.log("scm12.component.ts riceve l'anagrafica di: ",this.selectedMiq, "con status: ",this.status, this.dataframeData)
...
calcolaDifferenze_C() {
  ...
  private getWeekNumber(date: Date): number {
   ...
   campione(campione_di_riferimento:string): void{
    ...
    console.log("scm12.component.ts ha individuato questo campione_di riferimento: ", campione_di_riferimento);
