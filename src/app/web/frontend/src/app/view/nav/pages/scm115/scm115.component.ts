...
@Component({
  selector: 'app-scm115',
  templateUrl: './scm115.component.html',
  styleUrls: ['./scm115.component.less']
})
export class Scm115Component {
  ...
  ngOnInit(): void {
    this.scambio.selectedMiq$.subscribe((test: any) => {
      ...
      console.log("scm115.component.ts chiama getAnagrafica di: ", this.selectedMiq)
      ...
      console.log("scm115.component.ts riceve l'anagrafica di: ",this.selectedMiq, "con status: ",this.status, this.dataframeData)
...
calcolaDifferenze_B() {
  ...
  private getWeekNumber(date: Date): number {
   ...
   campione(campione_di_riferimento:string): void{
    ...
    console.log("scm115.component.ts ha individuato questo campione_di riferimento: ", campione_di_riferimento);
