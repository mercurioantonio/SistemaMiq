...
@Component({
  selector: 'app-scm122',
  templateUrl: './scm122.component.html',
  styleUrls: ['./scm122.component.less']
})
export class Scm122Component {
  ...
  ngOnInit(): void {
    this.scambio.selectedMiq$.subscribe((test: any) => {
      ...
      console.log("scm122.component.ts chiama getAnagrafica di: ", this.selectedMiq)
      ...
      console.log("scm122.component.ts riceve l'anagrafica di: ",this.selectedMiq, "con status: ",this.status, this.dataframeData)
    ...
    if (this.validateForm.valid) {
       ...
       console.log(option1, option2)
        ...
        if (check_pt_int_B === 0){
          ...
          else if(option1+option2 === val1+val2){
            if(option1 === 0){
              this.validateForm.value.val_calib_A = null;
              this.validateForm.value.val_calib_master_A = null;
            }
...
calcolaDifferenze_B() {
  ...
  showModal(): void {
    ...
    if (this.esito_A_x == 'True' && this.esito_A_r == 'True' && this.esito_B_x == 'True' && this.esito_B_r == 'True' && this.validateForm.valid){
      this.submitForm();
      this.showModal_ok();
  ...
  private getWeekNumber(date: Date): number {
   ...
   campione(campione_di_riferimento:string): void{
    ...
    console.log("scm122.component.ts ha individuato questo campione_di riferimento: ", campione_di_riferimento);
