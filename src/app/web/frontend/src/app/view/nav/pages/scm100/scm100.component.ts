...
@Component({
  selector: 'app-scm100',
  templateUrl: './scm100.component.html',
  styleUrls: ['./scm100.component.less']
})
export class Scm100Component {
  ...
  ngOnInit(): void {
    this.scambio.selectedMiq$.subscribe((test: any) => {
      ...
      console.log("scm100.component.ts chiama getAnagrafica di: ", this.selectedMiq)
      ...
      console.log("scm100.component.ts riceve l'anagrafica di: ",this.selectedMiq, "con status: ",this.status, this.dataframeData)
...
calcolaDifferenze_C() {
  ...
  private getWeekNumber(date: Date): number {
   ...
   campione(campione_di_riferimento:string): void{
    ...
    console.log("scm100.component.ts ha individuato questo campione_di riferimento: ", campione_di_riferimento);
