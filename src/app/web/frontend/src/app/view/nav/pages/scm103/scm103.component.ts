...
@Component({
  selector: 'app-scm103',
  templateUrl: './scm103.component.html',
  styleUrls: ['./scm103.component.less']
})
export class Scm103Component {
  ...
  ngOnInit(): void {
    this.scambio.selectedMiq$.subscribe((test: any) => {
      ...
      console.log("scm103.component.ts chiama getAnagrafica di: ", this.selectedMiq)
      ...
      console.log("scm103.component.ts riceve l'anagrafica di: ",this.selectedMiq, "con status: ",this.status, this.dataframeData)
...
calcolaDifferenze_D(){
  ...
  private getWeekNumber(date: Date): number {
   ...
   campione(campione_di_riferimento:string): void{
    ...
    console.log("scm103.component.ts ha individuato questo campione_di riferimento: ", campione_di_riferimento);
