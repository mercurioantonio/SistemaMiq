...
@Component({
  selector: 'app-scm111',
  templateUrl: './scm111.component.html',
  styleUrls: ['./scm111.component.less']
})
export class Scm111Component {
  ...
  ngOnInit(): void {
    this.scambio.selectedMiq$.subscribe((test: any) => {
      ...
      console.log("scm111.component.ts chiama getAnagrafica di: ", this.selectedMiq)
      ...
      console.log("scm111.component.ts riceve l'anagrafica di: ",this.selectedMiq, "con status: ",this.status, this.dataframeData)
...
calcolaDifferenze_D(){
  ...
  private getWeekNumber(date: Date): number {
   ...
   campione(campione_di_riferimento:string): void{
    ...
    console.log("scm111.component.ts ha individuato questo campione_di riferimento: ", campione_di_riferimento);
