...
@Component({
  selector: 'app-scm17',
  templateUrl: './scm17.component.html',
  styleUrls: ['./scm17.component.less']
})
export class Scm17Component {
  ...
  ngOnInit(): void {
      ...
      console.log("scm17.component.ts chiama getAnagrafica di: ", this.selectedMiq)
      ...
      console.log("scm17.component.ts riceve l'anagrafica di: ",this.selectedMiq, "con status: ",this.status, this.dataframeData)
...
//      cid: [[], [Validators.required,Validators.pattern("^[0-9]*$"),Validators.minLength(8), Validators.maxLength(8)]],
  ...
  private getWeekNumber(date: Date): number {
   ...
   campione(campione_di_riferimento:string): void{
    ...
    console.log("scm17.component.ts ha individuato questo campione_di riferimento: ", campione_di_riferimento);
