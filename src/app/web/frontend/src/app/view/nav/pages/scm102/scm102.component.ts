...
@Component({
  selector: 'app-scm102',
  templateUrl: './scm102.component.html',
  styleUrls: ['./scm102.component.less']
})
export class Scm102Component {
  ...
  ngOnInit(): void {
    this.scambio.selectedMiq$.subscribe((test: any) => {
      ...
      console.log("scm102.component.ts chiama getAnagrafica di: ", this.selectedMiq)
      ...
      console.log("scm102.component.ts riceve l'anagrafica di: ",this.selectedMiq, "con status: ",this.status, this.dataframeData)
...
calcolaDifferenze_D(){
  ...
  private getWeekNumber(date: Date): number {
   ...
   campione(campione_di_riferimento:string): void{
    ...
    console.log("scm102.component.ts ha individuato questo campione_di riferimento: ", campione_di_riferimento);
