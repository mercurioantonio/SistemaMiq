...
@Component({
  selector: 'app-scm9',
  templateUrl: './scm9.component.html',
  styleUrls: ['./scm9.component.less']
})
export class Scm9Component {
  ...
  ngOnInit(): void {
    this.scambio.selectedMiq$.subscribe((test: any) => {
      ...
      console.log("scm9.component.ts chiama getAnagrafica di: ", this.selectedMiq)
      ...
      console.log("scm9.component.ts riceve l'anagrafica di: ",this.selectedMiq, "con status: ",this.status, this.dataframeData)
...
calcolaDifferenze_D(){
  ...
  private getWeekNumber(date: Date): number {
   ...
   campione(campione_di_riferimento:string): void{
    ...
    console.log("scm9.component.ts ha individuato questo campione_di riferimento: ", campione_di_riferimento);
