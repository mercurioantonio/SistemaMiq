...
@Component({
  selector: 'app-scm6',
  templateUrl: './scm6.component.html',
  styleUrls: ['./scm6.component.less']
})
export class Scm6Component {
  ...
  ngOnInit(): void {
    this.scambio.selectedMiq$.subscribe((test: any) => {
      ...
      console.log("scm6.component.ts chiama getAnagrafica di: ", this.selectedMiq)
      ...
      console.log("scm6.component.ts riceve l'anagrafica di: ",this.selectedMiq, "con status: ",this.status, this.dataframeData)
...
//      cid: [[], [Validators.required,Validators.pattern("^[0-9]*$"),Validators.minLength(8), Validators.maxLength(8)]],
  ...
  private getWeekNumber(date: Date): number {
   ...
   campione(campione_di_riferimento:string): void{
    ...
    console.log("scm6.component.ts ha individuato questo campione_di riferimento: ", campione_di_riferimento);
