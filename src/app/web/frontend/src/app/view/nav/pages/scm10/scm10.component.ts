...
@Component({
  selector: 'app-scm10',
  templateUrl: './scm10.component.html',
  styleUrls: ['./scm10.component.less']
})
export class Scm10Component {
  ...
  ngOnInit(): void {
    this.scambio.selectedMiq$.subscribe((test: any) => {
      ...
      console.log("scm10.component.ts chiama getAnagrafica di: ", this.selectedMiq)
      ...
      console.log("scm10.component.ts riceve l'anagrafica di: ",this.selectedMiq, "con status: ",this.status, this.dataframeData)
...
calcolaDifferenze_D(){
  ...
  private getWeekNumber(date: Date): number {
   ...
   campione(campione_di_riferimento:string): void{
    ...
    console.log("scm10.component.ts ha individuato questo campione_di riferimento: ", campione_di_riferimento);
