...
@Component({
  selector: 'app-scm27',
  templateUrl: './scm27.component.html',
  styleUrls: ['./scm27.component.less']
})
export class Scm27Component {
  ...
  ngOnInit(): void {
    this.scambio.selectedMiq$.subscribe((test: any) => {
      ...
      console.log("scm27.component.ts chiama getAnagrafica di: ", this.selectedMiq)
      ...
      console.log("scm27.component.ts riceve l'anagrafica di: ",this.selectedMiq, "con status: ",this.status, this.dataframeData)
...
//      cid: [[], [Validators.required,Validators.pattern("^[0-9]*$"),Validators.minLength(8), Validators.maxLength(8)]],
  ...
  private getWeekNumber(date: Date): number {
   ...
   campione(campione_di_riferimento:string): void{
    ...
    console.log("scm27.component.ts ha individuato questo campione_di riferimento: ", campione_di_riferimento);
